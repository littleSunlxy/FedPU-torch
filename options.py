...
parser.add_argument('--positiveRate', type=float, default=2/3)#1
parser.add_argument('--randomIndex_num', type=int, default=5)

# FL aggregator
parser.add_argument('--num_clients', type=int, default=4)
parser.add_argument('--communication_rounds', type=int, default=4000)
...
parser.add_argument('--imagename', type=str, default='5.23.1.jpg')
