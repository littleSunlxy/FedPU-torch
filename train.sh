...
python main.py   --dataset 'CIFAR10' --method 'FedPU' --num_clients 1 --pu_batchsize 2048 --classes_per_client 10 --P_Index_accordance --positiveRate 0.5 --randomIndex_num 10 --local_epochs 1 --communication_rounds 5 --pu_lr 0.01 --clientSelect_Rate 1.0
