...
python main.py   --dataset 'CIFAR10' --method 'FedPU' --num_clients 2 --classes_per_client 10 --positiveRate 0.5 --randomIndex_num 10 --local_epochs 100 --communication_rounds 1 --pu_lr 0.01 --clientSelect_Rate 1.0
