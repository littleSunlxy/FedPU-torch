...
#01.log
python main.py  --useFedmatchDataLoader  --task 'lc-bimb-c10' --dataset 'CIFAR10' --method 'FedProx' --FedProx_Epochs 2 --mu 0.00 --percentage 0.0 --num_clients 100 --pu_batchsize 512 --communication_rounds 2000 --pu_lr 0.01 --clientSelect_Rate 0.1
#02.log
