...
python main.py   --dataset 'CIFAR10' --method 'FedProxSL' --adjust_lr --local_epochs 20 --communication_rounds 500 --pu_weight 1 --mu 0.1 --percentage 90 --num_clients 10 --pu_batchsize 512 --classes_per_client 5 --P_Index_accordance --positiveRate 0.33 --randomIndex_num 2 --pu_lr 0.01 --clientSelect_Rate 0.2
