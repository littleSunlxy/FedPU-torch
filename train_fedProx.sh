...
#01.log
python main.py  --useFedmatchDataLoader  --dataset 'CIFAR10' --method 'FedPU' "--usePU" --FedProx_Epochs 2 --mu 0.10 --percentage 0.0 --num_clients 100 --pu_batchsize 512 --communication_rounds 2000 --pu_lr 0.01 --clientSelect_Rate 0.1
