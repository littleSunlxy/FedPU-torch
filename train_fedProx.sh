...
# use_my_setting
python main.py   --dataset 'CIFAR10' --method 'FedProx' --usePU --num_clients 10 --pu_batchsize 2048 --classes_per_client 2 --P_Index_accordance --positiveRate 0.1 --randomIndex_num 2 --FedProx_Epochs 5 --communication_rounds 2000 --pu_lr 0.01 --clientSelect_Rate 0.1
