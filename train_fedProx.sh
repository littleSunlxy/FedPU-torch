...
#01.log
python main.py  --useFedmatchDataLoader --dataset 'CIFAR10' --method 'FedProx' --mu 0.00 --usePU ---percentage 0.0 --num_clients 100 --pu_batchsize 512 --communication_rounds 200 --pu_lr 0.01 --clientSelect_Rate 0.05
#02.log
