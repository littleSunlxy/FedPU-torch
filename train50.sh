...
# baseline 1
python main.py  --positiveRate 0.33  --positiveIndex '0' --local_epochs 8 --P_Index_accordance --randomIndex_num 2 --num_clients 50 --communication_rounds 2000 --classes_per_client 10 --clientSelect_Rate 0.1
