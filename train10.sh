...
#python main.py  --positiveRate 0.01 --randomIndex_num 2 --num_clients 100 --communication_rounds 200 --classes_per_client 10 --clientSelect_Rate 0.05
# client 20
python main.py  --positiveRate 0.33 --P_Index_accordance --randomIndex_num 2 --num_clients 10 --communication_rounds 2000 --classes_per_client 10 --clientSelect_Rate 0.5