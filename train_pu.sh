...
#
python main.py   --dataset 'CIFAR10' --method 'FedPU' --num_clients 10 --pu_batchsize 2048 --classes_per_client 5 --P_Index_accordance --positiveRate 0.5 --randomIndex_num 10 --local_epochs 5 --communication_rounds 50 --pu_lr 0.01 --clientSelect_Rate 1.0
