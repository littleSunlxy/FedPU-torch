...
python main.py   --dataset 'CIFAR10' --method 'FedAVG-SL' --num_clients 1 --local_epochs 200 --classes_per_client 10 --P_Index_accordance --positiveRate 0.99 --communication_rounds 400 --pu_lr 0.01 --clientSelect_Rate 0.05
